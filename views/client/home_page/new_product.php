        ...
        <div class="new_books owl-carousel">
            <div class="book">
                <div class="book_thumb">
                    <a href="../detail_book_page/index.php"><img src="../../../assets/images/home_page/1.jpg" alt=""
                            class="book_image"></a>
                </div>
            ...
            <div class="book">
                <div class="book_thumb">
                    <a href="../detail_book_page/index.php"><img src="../../../assets/images/home_page/7.jpg" alt=""
                            class="book_image"></a>
                </div>
                <div class="book_content">
                    <div class="product_content content_center">
            ...
            <div class="book">
                <div class="book_thumb">
                    <a href="../detail_book_page/index.php"><img src="../../../assets/images/home_page/8.jpg" alt=""
                            class="book_image"></a>
                </div>
                <div class="book_content">
                    <div class="product_content content_center">
            ...
            <div class="book">
                <div class="book_thumb">
                    <a><img src="../../../assets/images/home_page/9.jpg" alt="" class="book_image"></a>
                </div>
                <div class="book_content">
                    <div class="product_content content_center">
                        <h4><a href="single-product.html">Lando</a></h4>
            ...
            <div class="book">
                <div class="book_thumb">
                    <a><img src="../../../assets/images/home_page/5.jpg" alt="" class="book_image"></a>
                </div>
                <div class="book_content">
                    <div class="product_content content_center">
                        <h4><a href="single-product.html">Lando</a></h4>
