            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="infor_product">
                        <h4 class="titlebook">Rich Dad Poor Dad</h4>
                        <h6 class="author">Author: <span>Robert T.Kiyosaki</span></h6>
                        ...
                        <div class="description">
                            <p>
                                April 2017 marks 20 years since Robert Kiyosaki’s Rich Dad Poor Dad first made waves in the Personal Finance arena. </p>

                            <p> It has since become the #1 Personal Finance book of all translated into dozens of languages and sold around the world. </p>
                        </div>
                        <div class="line_1"></div>
                        <div class="address">
                ...
                <div class="tabproduct col-md-12">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="detailproduct" role="tabpanel" aria-labelledby="tab1">
                            ...
                            <p>
                                In the 20th Anniversary Edition of this classic, Robert offers an update on what we’ve seen over the past 20 years related to money, investing, and the global economy.
