                                ...
                                <table class="table table-striped table-hover table-responsive-lg" style="table-layout:fixed;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> <button class="btn btn-danger" onclick="deleteEmployee(<?php echo $row['id'] ?>)">Delete</button></td>  </td>
                                        </tr>
    ...
    <script>
        ...
        function editEmployee(employ_id){
            ...
            $.post(
                "post/employee_func.php",
                {
                    ...
                    id: id, fname: fname, work: work, avatar: avatar, face: face, twitter: twitter, insta: insta
                },
        ...
        function addEmployee(){
            ...
            $.post(
                ...
                {
                    action: "add_employee",
                    fname: fname, work: work, avatar: avatar, face: face, twitter: twitter, insta: insta
                },
                function (data, status){
                    alert(data);
